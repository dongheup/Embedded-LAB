...
#define Open207_LCD_BackLightControl_PIN		GPIO_Pin_0
#define Open207_LCD_BackLightControl_PORT		GPIOB
#define Open207_LCD_BackLightControl_CLK		RCC_AHB1Periph_GPIOB

#define Open207_LCD_Reset_PIN					GPIO_Pin_1
#define Open207_LCD_Reset_PORT					GPIOB
#define Open207_LCD_Reset_CLK					RCC_AHB1Periph_GPIOB	
