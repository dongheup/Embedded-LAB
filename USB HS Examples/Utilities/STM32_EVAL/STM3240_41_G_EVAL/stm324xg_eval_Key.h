...
#define JOY_A_KEY_Port					GPIOA
#define JOY_A_KEY_Pin					GPIO_Pin_4
#define JOY_A_KEY_RCC_AHBPeriph			RCC_AHB1Periph_GPIOA

#define JOY_B_KEY_Port					GPIOA
#define JOY_B_KEY_Pin					GPIO_Pin_6
#define JOY_B_KEY_RCC_AHBPeriph			RCC_AHB1Periph_GPIOA

#define JOY_C_KEY_Port					GPIOB
#define JOY_C_KEY_Pin					GPIO_Pin_15
#define JOY_C_KEY_RCC_AHBPeriph			RCC_AHB1Periph_GPIOB

#define JOY_D_KEY_Port					GPIOC
#define JOY_D_KEY_Pin					GPIO_Pin_6
#define JOY_D_KEY_RCC_AHBPeriph			RCC_AHB1Periph_GPIOC

#define JOY_CTR_KEY_Port				GPIOC
#define JOY_CTR_KEY_Pin					GPIO_Pin_7
